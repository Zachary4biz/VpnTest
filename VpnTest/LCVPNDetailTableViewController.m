...
@interface LCVPNDetailTableViewController ()<LCVPNDetailTableViewCellDelegate>

@end

@implementation LCVPNDetailTableViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    LCVPNDetailTableViewCell *cell = (LCVPNDetailTableViewCell *)[tableView dequeueReusableCellWithIdentifier:CellIdentifier];
    if (cell == nil) {
        cell=[[LCVPNDetailTableViewCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:CellIdentifier];//设置风格
        cell.delegate = self;
    }
...
- (void)setCellData:(NSIndexPath *)indexPath tocell:(LCVPNDetailTableViewCell *)tocell {
...
//                [tocell setCellRightText:[NSString stringWithFormat:@"%@",@"IPSec"]];
...
//                tocell.accessoryType = UITableViewCellAccessoryNone;
//                tocell.cellType = CellWithRightSwitch;
//                tocell.positionType = CellOnlyOne;
//                
//                break;
            }
        ...
        tocell.selectionStyle = UITableViewCellSelectionStyleNone;
        tocell.cellType = CellWithInputField;
        tocell.accessoryType = UITableViewCellAccessoryNone;
        switch (indexPath.row) {
            case 0:
                tocell.textLabel.text = @"服务器";
                [tocell setCellInputText:[NSString stringWithFormat:@"%@",self.vpnModel.adress] isSecretInput:NO];
//                tocell.imageView.image = [self itemImageWithName:@"settings_tell_friends" itemSize:CGSizeMake(30, 30)];
            ...
            case 1:
                ...
                [tocell setCellInputText:[NSString stringWithFormat:@"%@",self.vpnModel.account] isSecretInput:NO];
//                tocell.imageView.image = [self itemImageWithName:@"settings_rate_us" itemSize:CGSizeMake(30, 30)];
                tocell.positionType = CellMiddle;
                break;
            case 2:
                tocell.textLabel.text = @"密码";
                [tocell setCellInputText:[NSString stringWithFormat:@"%@",self.vpnModel.password] isSecretInput:YES];
                //                tocell.imageView.image = [self itemImageWithName:@"settings_feedback" itemSize:CGSizeMake(30, 30)];
                tocell.positionType = CellMiddle;
                break;
            case 3:
                tocell.textLabel.text = @"组群密钥";
                [tocell setCellInputText:[NSString stringWithFormat:@"%@",self.vpnModel.groupKey] isSecretInput:YES];
                //                tocell.imageView.image = [self itemImageWithName:@"settings_feedback" itemSize:CGSizeMake(30, 30)];
                tocell.positionType = CellLast;
                break;
//            case 3:
...
//    LCVPNDetailTableViewCell *cell = (LCVPNDetailTableViewCell *)[self tableView:self.tableView cellForRowAtIndexPath:[NSIndexPath indexPathForRow:0 inSection:1]];
//    return [cell getInputText];
//}
//-(NSString *)getVPNAccount{
//    LCVPNDetailTableViewCell *cell = (LCVPNDetailTableViewCell *)[self tableView:self.tableView cellForRowAtIndexPath:[NSIndexPath indexPathForRow:1 inSection:1]];
//    return [cell getInputText];
//}
//-(NSString *)getVPNPassword{
//    LCVPNDetailTableViewCell *cell = (LCVPNDetailTableViewCell *)[self tableView:self.tableView cellForRowAtIndexPath:[NSIndexPath indexPathForRow:2 inSection:1]];
//    return [cell getInputText];
//}
//-(NSString *)getVPNGroupKey{
//    LCVPNDetailTableViewCell *cell = (LCVPNDetailTableViewCell *)[self tableView:self.tableView cellForRowAtIndexPath:[NSIndexPath indexPathForRow:3 inSection:1]];
//    return [cell getInputText];
//}
...
- (void)contentDidChanged:(NSString *)text forIndexPath:(NSIndexPath *)indexPath {
    if (indexPath.row == 0) {
        self.vpnModel.adress = [NSString stringWithFormat:@"%@",text];
    }
    if (indexPath.row == 1) {
        self.vpnModel.account = [NSString stringWithFormat:@"%@",text];
    }
    if (indexPath.row == 2) {
        self.vpnModel.password = [NSString stringWithFormat:@"%@",text];
    }
    if (indexPath.row == 3) {
        self.vpnModel.groupKey = [NSString stringWithFormat:@"%@",text];
    }
}
