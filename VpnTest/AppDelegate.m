...
-(UIViewController *)setupRootViewController{
    ...
    rootVC.restorationIdentifier = NSStringFromClass(ViewController.self);
    rootVC.restorationClass = AppDelegate.self;
...
//    rootNavigationController.navigationBarHidden = YES;
    rootNavigationController.automaticallyAdjustsScrollViewInsets = NO;
    //!!!!!automaticallyAdjustsScrollViewInsets!viewcontroller下scrollerView自动下移20像素!!关闭之
//    rootNavigationController.delegate = self;
//    
//    if (customAnimators) {
//        self.customAnimator = [[BrowserAnimators alloc] init];
//    }
